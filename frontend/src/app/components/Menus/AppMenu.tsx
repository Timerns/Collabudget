...
import CreateGroupModal from '../Modals/CreateGroupe';
...
const AppMenu: FC<pageProps> = (props) => {
  ...
  const [groupes, setGroupes] = useState<GroupeType[]>([])
      ...
      <aside id="sidebar-multi-level-sidebar" className={"fixed top-0 left-0 z-30 w-64 h-screen transition-transform  sm:translate-x-0" + (navbarOpen ? "" : " -translate-x-full")} aria-label="Sidebar">
        <div className="flex flex-col h-full px-3 py-4 overflow-y-auto bg-light-secondary ">
          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              <div className="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
              ...
              <ul className="py-2 space-y-2">
                ...
                <li>
                  <div className={"flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group text-light-gray hover:text-primary"} onClick={show}>
                    ...
                    <CreateGroupModal title='Ajouter groupe' button='Ajouter' show={show} />
                  </div>
                </li>
              </ul>
            </li>
