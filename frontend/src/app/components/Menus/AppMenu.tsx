                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <a href="#" className="flex items-center p-2 text-light-gray group">
                                ...
                                <span className="ml-3 text-light-gray">Mes dépenses</span>
                            </a>
                        </li>
                        <li>
                            <button type="button" className="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                                ...
                                <span className="flex-1 ml-3 text-left whitespace-nowrap">Groupes</span>
                    ...
                    <ul className="self-end space-y-2 font-medium mt-auto mr-auto">
                        <li>
                            <a href="#" className="flex items-center p-2 text-light-gray group">
                                ...
                                <span className="ml-3 text-light-gray">Déconnexion</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="#" className="flex items-center p-2 text-light-gray group">
                                ...
                                <span className="ml-3 text-light-gray">Mon compte</span>
                            </a>
                        </li>
                        <li>
                            <a href="#" className="flex items-center p-2 text-light-gray group">
                                <svg className="w-5 h-5" width="25" height="25" viewBox="0 0 25 25" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M12.4999 16.7292C11.3783 16.7292 10.3026 16.2837 9.50945 15.4906C8.71633 14.6974 8.27076 13.6217 8.27076 12.5001C8.27076 11.3784 8.71633 10.3027 9.50945 9.50961C10.3026 8.71649 11.3783 8.27092 12.4999 8.27092C13.6216 8.27092 14.6973 8.71649 15.4904 9.50961C16.2835 10.3027 16.7291 11.3784 16.7291 12.5001C16.7291 13.6217 16.2835 14.6974 15.4904 15.4906C14.6973 16.2837 13.6216 16.7292 12.4999 16.7292ZM21.4778 13.6722C21.5262 13.2855 21.5624 12.8988 21.5624 12.5001C21.5624 12.1013 21.5262 11.7026 21.4778 11.2918L24.0274 9.32217C24.257 9.14092 24.3174 8.81467 24.1724 8.54883L21.7558 4.368C21.6108 4.10217 21.2845 3.99342 21.0187 4.10217L18.0099 5.3105C17.3816 4.83925 16.7291 4.42842 15.9678 4.12633L15.5208 0.92425C15.4962 0.781929 15.4221 0.652891 15.3115 0.56C15.2009 0.467109 15.061 0.416362 14.9166 0.41675H10.0833C9.78118 0.41675 9.52743 0.63425 9.47909 0.92425L9.03201 4.12633C8.27076 4.42842 7.61826 4.83925 6.98993 5.3105L3.98118 4.10217C3.71534 3.99342 3.38909 4.10217 3.24409 4.368L0.827428 8.54883C0.670345 8.81467 0.742845 9.14092 0.972428 9.32217L3.52201 11.2918C3.47368 11.7026 3.43743 12.1013 3.43743 12.5001C3.43743 12.8988 3.47368 13.2855 3.52201 13.6722L0.972428 15.678C0.742845 15.8593 0.670345 16.1855 0.827428 16.4513L3.24409 20.6322C3.38909 20.898 3.71534 20.9947 3.98118 20.898L6.98993 19.6776C7.61826 20.1609 8.27076 20.5718 9.03201 20.8738L9.47909 24.0759C9.52743 24.3659 9.78118 24.5834 10.0833 24.5834H14.9166C15.2187 24.5834 15.4724 24.3659 15.5208 24.0759L15.9678 20.8738C16.7291 20.5597 17.3816 20.1609 18.0099 19.6776L21.0187 20.898C21.2845 20.9947 21.6108 20.898 21.7558 20.6322L24.1724 16.4513C24.3174 16.1855 24.257 15.8593 24.0274 15.678L21.4778 13.6722Z" />
                                </svg>
