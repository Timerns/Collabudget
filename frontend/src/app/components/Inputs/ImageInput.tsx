...
const ImageInput = React.forwardRef<HTMLInputElement, ImageInputProps & ReturnType<UseFormRegister<any>>>((props, ref) => {
  ...
  return (
    <Input {...props}>
      <label className="block cursor-pointer shadow bg-white appearance-none border rounded w-full" htmlFor={props.name}>
        <div className="w-full items-center justify-center flex">
          <svg className="absolute w-10 h-10 text-gray-800 dark:text-dark stroke-light-secondary" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16">
